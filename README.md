...
AI Youtube Shorts Generator is a Python tool designed to generate engaging YouTube shorts from long-form videos. By leveraging the power of Google Gemini and Whisper, it extracts the most interesting highlights, detects speakers, and crops the content vertically for shorts. This tool is currently in version 0.1 and might have some bugs.
...
- **Highlight Extraction**: Utilizes Google Gemini to identify the most engaging parts of the video.
